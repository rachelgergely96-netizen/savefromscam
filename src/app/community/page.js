    ...
    <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="space-y-3">
        {COMMUNITY_POSTS.map((post, i) => (
          <div
            key={i}
            className="card-flat rounded-2xl p-5 border border-sage-200 dark:border-dark-border hover:border-teal-500/30 dark:hover:border-dark-teal-primary/30 transition-colors"
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                {post.verified && (
                  <span className="text-xs text-teal-600 dark:text-dark-teal-primary" title="Verified">
                    &#10003;
                  </span>
                )}
              </div>
            </div>
            <p className="text-sm text-navy-700 dark:text-dark-text-secondary leading-relaxed mb-3 font-sans">
              {post.scam}
            </p>
